...
namespace System.Linq.MyDynamic
{
    public static class DynamicQueryable
    {
        ...
        public static int Max(this IQueryable source)
        {
            if (source == null) throw new ArgumentNullException(nameof(source));
            return (int)source.Provider.Execute(
                Expression.Call(
    ...
    internal class ClassFactory
    {
        ...
        private ClassFactory()
        {
            ...
            AssemblyBuilder assembly = AssemblyBuilder.DefineDynamicAssembly(name , //new AssemblyName(Guid.NewGuid().ToString()),
            AssemblyBuilderAccess.Run); // AppDomain.CurrentDomain.DefineDynamicAssembly(name, AssemblyBuilderAccess.Run);
